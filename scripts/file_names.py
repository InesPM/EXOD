...
# software installation paths (to be modified by the user)
...
SAS_CCFPATH = "/home/ines/astrosoft/xmmsas_20180620_1732/ccf/"

# local path variables (to be modified by the user)
